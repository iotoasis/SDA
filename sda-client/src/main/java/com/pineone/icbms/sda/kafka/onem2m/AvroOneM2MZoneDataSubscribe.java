...
// thread로 돌리는 경우
public class AvroOneM2MZoneDataSubscribe implements Serializable  {
	private static final long serialVersionUID = 4669761147227806892L;
	private final String TOPIC = Utils.KafkaTopics.COL_ONEM2M.toString();
	private final Log log = LogFactory.getLog(AvroOneM2MZoneDataSubscribe.class);
	...
	public static void main(String[] args) throws Exception{
		AvroOneM2MZoneDataSubscribe avroOneM2MZoneDataSubscribe = new AvroOneM2MZoneDataSubscribe();
		avroOneM2MZoneDataSubscribe.collect();
	}
