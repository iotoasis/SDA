...
public class CollectStatusDataFromSIJobService extends SchedulerJobComm implements Job {
	...
	public void collect(String ip, int port, String dbname, String save_path, JobExecutionContext jec)
		...
		log.debug("CollectStatusDataFromSIJobService(id : "+jec.getJobDetail().getName()+") start.......................");
		...
		//String a = java.util.regex.Pattern.compile(m).toString();
		//log.debug("pattern.toString() : "+a);
		...
		if( sb.length() > 0) {
			...
			log.debug("CollectStatusDataFromSIJobService(id : "+jec.getJobDetail().getName()+") end.......................");			
		}
