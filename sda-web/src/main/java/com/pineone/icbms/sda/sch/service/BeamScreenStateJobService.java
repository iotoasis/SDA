...
@Service
public class BeamScreenStateJobService extends SchedulerJobComm implements Job {
	...
	public void runner(JobExecutionContext jec) throws Exception {
		...
		log.info("BeamScreenStateJobService(id : "+jec.getJobDetail().getName()+") start.......................");
...
//			List<Map<String, String>> aggrResultList;
			...
			log.info("BeamScreenStateJobService(id : "+jec.getJobDetail().getName()+") end.......................");			
		} catch (Exception e) {
