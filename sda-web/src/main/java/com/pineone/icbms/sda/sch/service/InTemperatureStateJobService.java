...
@Service
public class InTemperatureStateJobService extends SchedulerJobComm implements Job {
	...
	public void runner(JobExecutionContext jec) throws Exception {
		...
		log.info("InTemperatureStateJobService(id : "+jec.getJobDetail().getName()+") start.......................");
...
//			List<Map<String, String>> aggrResultList;
			...
			log.info("InTemperatureStateJobService(id : "+jec.getJobDetail().getName()+") end.......................");			
		} catch (Exception e) {
